...
> {
  ...
  onAutoscrollComplete = (params: readonly number[]) => {
    // console.log("onAutoscrollComplete!");
  ...
  getScrollTargetOffset = (
    ...
    // console.log("getScrollTargetOffset");
        ...
        block([
          onChange(
            ...
            call([this.spacerIndex], ([spacerIndex]) => {
              //   console.log("renderOnPlaceholderIndexChange");
  ...
  CellRendererComponent = (cellProps: any) => {
    // console.log("CellRendererComponent");
